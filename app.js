...
server.get("/game.js", (req, res) => {
  //logger.log("http request: /game.js");
  res.sendFile(__dirname + "/client/game.js");
})

var clients = [];
var chat = [];
var playerConnectionTimeout = 25_000;
...
io.on("connection", (socket) => {
  ...
  logger.log("" + socket.request.connection.remoteAddress)
  logger.log("" + socket.conn.transport.socket._socket.remoteAddress)
